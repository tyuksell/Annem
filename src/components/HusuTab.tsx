      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#2a4433] via-[#3d5a45] to-[#1f3326] text-white p-6 sm:p-8 shadow-xl">
        ...
        <div className="mt-6 pt-6 border-t border-white/15 grid grid-cols-2 sm:grid-cols-3 gap-4">
          <div className="bg-white/10 backdrop-blur-xs rounded-2xl p-3.5 border border-white/10 flex items-center gap-3">
            ...
            <div>
              <p className="text-[11px] text-emerald-100/80 uppercase tracking-wider font-medium">Tamamlanan</p>
          ...
          <div className="bg-white/10 backdrop-blur-xs rounded-2xl p-3.5 border border-white/10 flex items-center gap-3">
            ...
            <div>
              <p className="text-[11px] text-emerald-100/80 uppercase tracking-wider font-medium">Bugün Çekilen</p>
              <p className="text-lg font-bold text-white font-serif">{totalDhikrSum} Adet</p>
            </div>
          </div>

          <div className="col-span-2 sm:col-span-1 bg-white/10 backdrop-blur-xs rounded-2xl p-3.5 border border-white/10 flex items-center justify-between gap-3">
            <div>
              <p className="text-[11px] text-emerald-100/80 uppercase tracking-wider font-medium">Genel İlerleme</p>
